...
class BoundGenerator:
    '''
    生成一对浮点值，表示给定样本空间的下限和上限。bound(边界)
    '''
    def __init__(self,
        ...
        Arguments:
            ...
            weights (list or tuple, optional):样本空间的分布. `None`, 将假设均匀分布。
        '''
        ...
        if self.check_overlap:
            ...
            if self.overlap_criterion == 'iou':
                ...
                if self.border_pixels == 'half':
                    ...
                    d = 1  # `xmax - xmin + 1` or `ymax - ymin + 1`.
